                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                                                        {task.priority === 'high' && !task.isCompleted && (
                                                            <span className="text-[9px] font-bold text-red-400 bg-red-400/10 px-1.5 py-0.5 rounded uppercase tracking-wider">
                                                                High
                                                            </span>
                                                        )}
                                                        {subtasks.length > 0 && (
                                                            <span className="text-[9px] text-gray-500 flex items-center gap-1">
                                                                <Icon name="ListChecks" size={10}/> {completedSub}/{subtasks.length}
                                                            </span>
                                                        )}
                                                        {task.attachmentUrl && (
