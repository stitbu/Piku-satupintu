                  ...
                  <div key={idx} className="flex gap-3 bg-white/5 p-3 rounded-lg border border-white/5 items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-2">
                        <span className="text-[10px] bg-blue-500/20 text-blue-300 px-1.5 py-0.5 rounded border border-blue-500/30 uppercase">{task.divisionId}</span>
                        <span className={`text-[10px] px-1.5 py-0.5 rounded border uppercase ${task.priority === 'high' ? 'bg-red-500/20 text-red-300 border-red-500/30' : 'bg-gray-700 text-gray-300 border-gray-600'}`}>{task.priority}</span>
                      </div>
                    </div>
